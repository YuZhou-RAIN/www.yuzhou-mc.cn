...
const i18nData = {
  zh: {
    ...
    banner: { deprecation: 'yuzhou-mc.cn 将于 2027 年 7 月到期，请使用 yzmc.top 访问' },
    lang: {
  ...
  en: {
    ...
    banner: { deprecation: 'yuzhou-mc.cn will expire in July 2027, please use yzmc.top' },
    lang: {
  ...
  ja: {
    ...
    banner: { deprecation: 'yuzhou-mc.cn は 2027 年 7 月に失効します。yzmc.top をご利用ください' },
    lang: {
  ...
  ko: {
    ...
    banner: { deprecation: 'yuzhou-mc.cn은 2027년 7월에 만료됩니다. yzmc.top을 사용해 주세요' },
    lang: {
